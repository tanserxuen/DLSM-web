...
final refreshTokenHiveServiceProvider = Provider<RefreshTokenHiveService>((ref) => RefreshTokenHiveService(ref));
...
class RefreshTokenHiveService extends RiverpodService {
  ...
  Future<RefreshTokenBox> get _getRefreshTokenBox async {
    _refreshTokenBox ??= await Hive.openBox<RefreshTokenBoxValue>('refreshTokenBox');
