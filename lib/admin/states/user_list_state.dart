...
final userListStateProvider = StateNotifierProvider<UserListStateNotifier, UserListState>(
...
class UserListStateNotifier extends RiverpodStateNotifier<UserListState> {
  ...
  UserListStateNotifier(StateNotifierProviderRef ref) : super( UserListState(), ref);
